  ...
  <div class="content">
    ...
    <div class="row">
      <div class="col-lg-4">
        <div class="card card-chart">
          <div class="card-header">
            ...
            <h3 class="card-title">
              <i class="tim-icons icon-bulb-63 text-primary"></i> 24°
            </h3>
          </div>
          <div class="card-body">
            <div class="chart-area">
      ...
      <div class="col-lg-4">
        <div class="card card-chart">
          <div class="card-header">
            <h5 class="card-category">Energia Consumida Total</h5>
            <h3 class="card-title">
              <i class="tim-icons icon-send text-success"></i> 12,100 kWh
            </h3>
          </div>
          <div class="card-body">
            <div class="chart-area">
